{
  manager = {
    keymap = [
      ...
      { desc = "Close the current tab, or quit if it is last tab"     ; on = [ "<C-w>" ]       ; run = "close"                                              ; }
      ...
      { desc = "Seek up 5 units in the preview"                       ; on = [ "<A-Up>" ]      ; run = "seek -5"                                            ; }
      { desc = "Seek down 5 units in the preview"                     ; on = [ "<A-Down>" ]    ; run = "seek 5"                                             ; }
      ...
      { desc = "Cancel the yank status of files"                      ; on = [ "X" ]           ; run = [ "unyank" "escape --visual --select" ]              ; }
      { desc = "Paste the files"                                      ; on = [ "p" ]           ; run = "paste"                                              ; }
      { desc = "Paste the files (overwrite)"                          ; on = [ "P" ]           ; run = "paste --force"                                      ; }
      ...
      { desc = "Create a file or directory(append /)"                 ; on = [ "a" ]           ; run = "create"                                             ; }
      ...
      { desc = "Hardlink files"                                       ; on = [ "<C-->" ]       ; run = "hardlink"                                           ; }

      { desc = "Run a shell command"                                  ; on = [ ":" ]           ; run = "shell --interactive"                                ; }
      { desc = "Run a shell command & block UI"                       ; on = [ ";" ]           ; run = "shell --interactive --block"                        ; }
      ...
      { desc = "Jump to a directory using zoxide"                     ; on = [ "g" "z" ]       ; run = "plugin zoxide"                                        ; }
      { desc = "Jump to a directory, or reveal a file using fzf"      ; on = [ "g" "f" ]       ; run = "plugin fzf"                                           ; }
  ...
  input.keymap = [
    ...
    { desc = "Redo the last operation"                               ; on = [ "R" ]          ; run = "redo"                                    ; }
  ...
  completion.keymap = [
    { desc = "Cancel completion"              ; on = [ "<Esc>" ]  ; run = "close"                                    ; }
  ...
  tasks.keymap = [
    ...
    { desc = "Cancel the task"      ; on = [ "k" ]      ; run = "cancel"  ; }
  ...
  help.keymap = [
    ...
    { desc = "Exit the process"                  ; on = [ "~" ]       ; run = "close"   ; }
