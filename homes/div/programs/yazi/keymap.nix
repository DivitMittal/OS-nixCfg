{
  ...
  input = {
    keymap = [
      ...
      { desc = "Delete the character under the cursor"; on = [ "<C-d>" ]; run = "backspace --under"; }
  ...
  manager = {
    keymap = [
      ...
      { desc = "Run a shell command"; on = [ ";" ]; run = "shell"; }
      { desc = "Run a shell command (block the UI until the command finishes)"; on = [ ":" ]; run = "shell --block"; }
