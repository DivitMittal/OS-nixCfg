...

{
  programs.vim = {
    ...
    extraConfig = ''
      ...
      " Turn on the Wild menu, enhance command-line completion
      set wildmenu
      ...
      " Makes search act like search in modern browsers,i.e., searches are done after every character in the regex query typed
      set incsearch
